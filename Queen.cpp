...
#include "Queen.h"
Queen::Queen(Color col, PieceType piece_type) : ChessPieceI(col, piece_type) {
  this->pieceValue = 9;
...
std::vector<position> Queen::getThreatList(std::array<std::array<ChessPieceI *, 8>, 8> objMap, const position objPosition) {
